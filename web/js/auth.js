...
const teamRoles = {
    ...
    admin: [
        ...
        { name: "Nastasha Jackson", role: "Finance Manager", access: "all", password: null },
...
const milestoneOwners = {
    // TURNAROUND PROJECT
    "T1-M1": ["Nastasha Jackson"], // File VAT Returns - Finance Manager
    "T1-M2": ["Nastasha Jackson"], // SARS Payment Plan - Finance Manager
    "T1-M3": ["Berno Paul"], // Maintenance Cap - Clinical Lead
    "T1-M4": ["Nastasha Jackson"], // 13-Week Cash Forecast - Finance Manager
    ...
    "P1-M4": ["Nastasha Jackson", "Bertha Vorster"], // Pricing & Billing Policy - Finance & Admin
    ...
    "P2-M6": ["Nastasha Jackson"], // Phase 2 Financial Review - Finance Manager
    ...
    "P3-M6": ["Nastasha Jackson"], // Phase 3 Financial Review - Finance Manager
    ...
    "P4-M6": ["Nastasha Jackson"], // Phase 4 Financial Review - Finance Manager
    ...
    "P5-M7": ["Nastasha Jackson"], // Financial Performance Report - Finance Manager
